                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="margin-b-20">
														...
														<a href="<?php echo base_url();?>index.php/hydrogen">
                            <img class="img-responsive" src="<?php echo base_url();?>img/970x647/maquinas.jpg" alt="imagen seccion maquinas">
														</a>
                        </div>
                        <h4><a href="<?php echo base_url();?>index.php/hydrogen">Flota de veh&iacute;culos</a> <span class="text-uppercase margin-l-20">Flota</span></h4>
                        ...
                        <a class="link" href="<?php echo base_url();?>index.php/hydrogen">Galer&iacute;a</a>
                    </div>
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        ...
                        <h4><a href=<?php echo base_url();?>index.php/hydrogen">Herramientas</a> <span class="text-uppercase margin-l-20">Herramientras</span></h4>
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="margin-b-20">
                                                        <a href="<?php echo base_url();?>index.php/epic">
                            <img class="img-responsive" src="<?php echo base_url()?>img/970x647/proyectos.jpg" alt="inmagen seccion proyectos">
														</a>
                        </div>
                        <h4><a href="<?php echo base_url();?>index.php/epic"> Proyectos</a> <span class="text-uppercase margin-l-20">Proyectos</span></h4>
                        ...
                        <a class="link" href="<?php echo base_url();?>index.php/epic">Galer&iacute;a</a>
                    </div>
            </div>
        </div>
        <!-- End Latest Products -->
